...
main (int argc, char** argv)
{
  ...
  reader.read ("3-novo.pcd", *cloud_blob);
  ...
  writer.write<pcl::PointXYZ> ("4-novo.pcd", *cloud_filtered, false);
  ...
  //vector<int> g1; 
  //g1.push_back((255 << 16 | (0) << 8 | (0))); 
  //g1.push_back((0 << 16 | (255) << 8 | (0))); 
  //g1.push_back((0 << 16 | (0) << 8 | (255))); 
